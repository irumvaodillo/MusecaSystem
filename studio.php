...
<body>
  ...
  <div class="site-wrap">
    ...
    <img src="images/bazou.jpg" alt="dj bazou" class="mr-1 mt-1 rounded-square" style="width:100px;">
 </div>
              </ul>
   ...
   <a href="#" ><button type="button" class='btn btn-outline-info' name="add">action to day records</button></a>
