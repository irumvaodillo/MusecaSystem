        ...
        <div class="row">
          <div class="col-md-12 text-center">
                ...
                <table class="order_table">
                    <tr><th>PRODUCT</th><th>SPECIFICATION</th><th>QUANTITY</th><th>PRICE</th><th>CUSTOMER</th><th>PHONE</th><th>STATE</th><th>ZIP CODE</th><th>ADDRESS</th><th>BANK SLIP</th></tr>
                    <?php
                        $sel1 = mysqli_query($conn, "SELECT * FROM orders");
                        while($data = mysqli_fetch_array($sel1))
                        {
                            ...
                            $sel3 = mysqli_query($conn, "SELECT * FROM products WHERE prod_id='".$data['product']."'");
                            $data3 = mysqli_fetch_array($sel3);
                    ?>
                      <tr><td><?php echo $data3['ProductName']; ?></td><td><?php echo $data3['ProductDescription']; ?></td>
                      <td><?php echo $data['quantity']; ?></td><td><?php echo $data3['ProductPrice'] * $data['quantity']; ?></td>
                      <td><?php echo $data2['Firstname']." ".$data2['Lastname']; ?></td><td><?php echo $data2['Phone']; ?></td>
                      <td><?php echo $data['state']; ?></td><td><?php echo $data['zip']; ?></td>
                      <td><?php echo $data['address1']." - ".$data['address2']; ?></td><td><?php echo $data['bankSlip']; ?></td></tr>  
                    <?php
                        }
                    ?>
                </table>           
