...
<body>
  ...
  <div class="site-wrap">
    ...
    <center><div class="site-section">
      ...
      ?>
        <form action='#' method="post">
          <div class="col-md-7 text-center item mb-4">
            <span class="tag">Sale</span>
            <?php echo "<a href='shop-single.php?data=" . urlencode(serialize($data)) . "'>"; ?><img src="<?php echo $data['image']; ?>" alt="Image"></a>
            <h3 class="text-dark" style="white-space: pre"><?php echo "<a href='shop-single.php?data=" . urlencode(serialize($data)) . "'>"; ?><?php echo $data['ProductName']; ?></a></h3>
            <p class="price"><!--<del>95.00</del> &mdash;--> <?php echo $data['ProductPrice']." Frw"; ?></p>
            <?php echo "<a href='checkout.php?x=".$data['prod_id']."&data=" . urlencode(serialize($data)) . "'>"; ?><button type="button" class='btn btn-info' name="add">Place Order</button></a>
          </div>
        </form>
      <?php
        endwhile;
